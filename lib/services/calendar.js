...
module.exports = class CalendarService extends Schmervice.Service {
  /**
   *
   * @param {integer} userId : unique id of the volunteer
   * @param {string} userEmail : email of the volunteer
   * @returns a unique authorization URL for calendar consent
   */
  /* eslint-disable */
   ...
   * @param {integer} userId : unique id of the volunteer
   * @param {string} userEmail : email of the volunteer
   * @returns oauth client object set for a partcular volunteer
   */
  ...
  /**
   *
   * @param {object} classDetails : object with class details like time etc
   * @param {object} facilitator : object with facilitator's details
   * @returns a new calendar event
   */
   ...
   *
   * @param {object} classDetails : object with class details like time etc
   * @param {object} attendees : list of all attendees for the event
   * @returns an updated calendar event
   */
  ...
  /**
   *
   * @param {string} eventId : unique id for the calendar event
   * @param {integer} userId : id for the user trying to delete the calendar event
   * @param {integer} userEmail : email for the user trying to delete the calendar event
   * @returns delete the calendar event
   */
   ...
   *
   * @param {string} eventId : unique id for the calendar event
   * @param {integer} userId : id for the user trying to get the instances of a recurring calendar event
   * @param {integer} userEmail : email for the user trying to get the instances of a recurring calendar event
   * @returns all the instances of a recurring calendar event
   */
   ...
   *
   * @param {string} eventId : unique id for the calendar event
   * @param {integer} userId : id for the user trying to get the calendar event details
   * @param {integer} userEmail : email for the user trying to get the calendar event details
   * @returns details of a an calendar event
   */
