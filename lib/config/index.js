...
module.exports = {
  ...
  auth: {
    ...
    meraki1: {
      googleClientID: process.env.MERAKI_AUTH_CLIENT_ID_1,
      googleClientSecret: process.env.MERAKI_AUTH_CLIENT_SECRET_1,
      authRefreshToken: process.env.MERAKI_AUTH_REFRESH_TOKEN_1,
    },
    meraki2: {
      googleClientID: process.env.MERAKI_AUTH_CLIENT_ID_2,
      googleClientSecret: process.env.MERAKI_AUTH_CLIENT_SECRET_2,
      authRefreshToken: process.env.MERAKI_AUTH_REFRESH_TOKEN_2,
    },
    translation: {
